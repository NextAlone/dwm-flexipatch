...
#else
static const char *fonts[] = {"monospace:size=10", "Material Design Icons Desktop:style=Regular:size=12"};
...
static char *colors[][ColCount] = {
    ...
    [SchemeTitleNorm] = {titlenormfgcolor, black, titlenormbordercolor, titlenormfloatcolor},
    [SchemeTitleSel] = {gray3, black, titleselbordercolor, titleselfloatcolor},
    [SchemeTagsNorm] = {gray3, black, black, tagsnormfloatcolor},
    [SchemeTagsSel] = {gray4, black, black, tagsselfloatcolor},
    [SchemeHidNorm] = {hidnormfgcolor, black, c000000, c000000},
